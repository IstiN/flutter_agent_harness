...
class _Logo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        // Dark navy rounded square with a blue sparkle, like the reference.
        Container(
          width: 30, height: 30,
          ...
          child: const Icon(Icons.auto_awesome,
            size: 15, color: Color(0xFF5B8DEF)),
        ),
        const SizedBox(width: 8),
        const Text('Fa', style: TextStyle(
      ...
      builder: (context, constraints) {
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              Positioned(
                left: seg / 2, right: seg / 2, top: dot / 2 - 1,
      ...
      child: Column(
        children: [
          Text(
            '${page + 1} of 4',
            style: const TextStyle(
              fontSize: 12.5, fontWeight: FontWeight.w600, color: _kPrimary),
          ),
            ...
            children: [
              ...
              Expanded(
                child: _PrimaryButton(
                  label: primaryLabel, onTap: onPrimary, showArrow: false),
              ),
            ],
          ),
          privacy,
...
class _NarrowFit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final w = constraints.maxWidth > 460
            ? 460.0
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Text('Build a focus timer with work and break sessions.',
                    style: TextStyle(fontSize: 13, color: _kInk, height: 1.35)),
                  const SizedBox(height: 4),
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    Text(wide ? 'Just now' : '9:41 AM', style: const TextStyle(
                      fontSize: 10, color: _kGrayLight)),
      ...
      child: Column(
        ...
        children: [
          const Row(children: [
            ...
            SizedBox(width: 8),
            Expanded(
              child: Text('Understanding your request…', style: TextStyle(
...
class _FaAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _kNavy, borderRadius: BorderRadius.circular(size * 0.3)),
      child: Icon(Icons.auto_awesome, size: size * 0.5,
        ...
        children: [
          ...
          const Expanded(
            child: Text('Ask anything…', style: TextStyle(
              fontSize: 12.5, color: _kGrayLight)),
          ),
          Container(
            width: 30, height: 30,
        ...
        children: [
          ...
          const Row(children: [
            ...
            Text('Active', style: TextStyle(
              fontSize: 10.5, color: Color(0xFF34D399),
          ...
          Column(
            ...
            children: [
              Text('25:00', style: TextStyle(
                fontSize: timeSize, fontWeight: FontWeight.w800,
                color: Colors.white, letterSpacing: -0.5)),
              Text('Focus time', style: TextStyle(
                fontSize: timeSize * 0.38, color: Colors.white70)),
            ],
          ),
        ],
      ),
...
enum _AppKind {
  calendar, notes, utilities, files, calculator, maps,
  focusTimer, settings, addApp, habitGarden, createWithFa,
}
...
class _AppTile extends StatelessWidget {
          ...
          Positioned(
            ...
            child: badge == '1'
                ? Container(
                    ...
                    decoration: const BoxDecoration(
                      color: _kPrimary, shape: BoxShape.circle),
                    child: const Center(child: Text('1', style:
      ...
      child: Column(
        ...
        children: [
          ...
          Text(label, textAlign: TextAlign.center, style: const TextStyle(
            fontSize: 9.5, color: _kGray, fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
  ...
  Widget _glyph(double s) => switch (kind) {
    _AppKind.calendar => Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Container(width: 20 * s, height: 4 * s,
            decoration: BoxDecoration(color: const Color(0xFF2F7CF6),
              borderRadius: BorderRadius.circular(2))),
          SizedBox(height: 2 * s),
          Text('31', style: TextStyle(fontSize: 15 * s,
            fontWeight: FontWeight.w800, color: const Color(0xFF2F7CF6),
            height: 1)),
        ],
      ),
    _AppKind.notes => Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Container(width: 22 * s, height: 6 * s,
            decoration: BoxDecoration(color: const Color(0xFFFBBF24),
              borderRadius: BorderRadius.circular(3))),
          SizedBox(height: 3 * s),
          for (var i = 0; i < 3; i++)
            Container(width: 18 * s, height: 2 * s,
              margin: EdgeInsets.symmetric(vertical: 1.4 * s),
              decoration: BoxDecoration(color: const Color(0xFFD8DBE6),
                borderRadius: BorderRadius.circular(1))),
        ],
      ),
    _AppKind.utilities => Wrap(
        spacing: 2.5 * s, runSpacing: 2.5 * s,
        children: [
          for (final c in const [Color(0xFF5B8DEF), Color(0xFFFBBF24),
              Color(0xFF2EBD9E), Color(0xFF9AA0B4)])
            Container(width: 9 * s, height: 9 * s,
    ...
    _AppKind.calculator => Wrap(
        spacing: 2 * s, runSpacing: 2 * s,
        children: [
          for (var i = 0; i < 9; i++)
            Container(width: 5 * s, height: 5 * s,
              decoration: BoxDecoration(
                color: i == 7
    ...
    _AppKind.maps => Icon(Icons.place, size: 24 * s,
        color: const Color(0xFFEA4335)),
    _AppKind.focusTimer => SizedBox(
        width: 24 * s, height: 24 * s,
        child: CircularProgressIndicator(
          value: 0.75, strokeWidth: 2.5 * s,
          backgroundColor: Colors.white.withValues(alpha: 0.2),
          valueColor: const AlwaysStoppedAnimation(Color(0xFF5B8DEF)),
        ),
      ),
    _AppKind.settings => Icon(Icons.settings, size: 24 * s,
        color: const Color(0xFF7A7F96)),
    _AppKind.addApp || _AppKind.createWithFa =>
      Icon(Icons.add, size: 24 * s, color: const Color(0xFF9AA0B4)),
    _AppKind.habitGarden => Icon(Icons.eco, size: 22 * s,
                ...
                child: _card(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        flex: 11,
                        child: _AppsGrid(columns: 3, kinds: const [
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Your idea', style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(14),
        boxShadow: const [
          BoxShadow(color: Color(0x1410132B), blurRadius: 16,
            offset: Offset(0, 4)),
        ],
      ),
      child: const Row(
        ...
        children: [
          for (final (icon, label, color) in _items) ...[
            ...
            Text(label, style: const TextStyle(
              fontSize: 12.5, fontWeight: FontWeight.w500, color: _kGray)),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        const Text('Connect a provider to start chatting.',
          style: TextStyle(fontSize: 11.5, color: _kGray)),
        const SizedBox(height: 16),
        _ghostRow(Icons.autorenew, 'OpenRouter', 'Recommended',
          'Access 100+ models from top AI providers.'),
        _ghostRow(Icons.cruelty_free, 'Ollama', 'Local',
          'Run open-source models on your device.'),
        _ghostRow(Icons.auto_awesome, 'Google Gemini', null,
          "Google's latest models with advanced reasoning."),
        _ghostRow(Icons.code, 'Custom provider', null,
              ...
              children: [
                Row(children: [
                  Flexible(child: Text(name, style: const TextStyle(
                    ...
                    color: _kInk), overflow: TextOverflow.ellipsis)),
                  if (badge != null) ...[
                ...
                Text(desc, style: const TextStyle(
                  fontSize: 10.5, color: _kGray, height: 1.3)),
              ],
            ),
          ),
        ],
...
class _P2State extends State<_P2> {
  ...
  Widget _cards() {
    return Column(
      children: [
        _ProviderCard(
          icon: Icons.autorenew, name: 'OpenRouter', badge: 'Recommended',
        ...
        const SizedBox(height: 10),
        _ProviderCard(
          icon: Icons.cruelty_free, name: 'Ollama', badge: 'Local',
        ...
        const SizedBox(height: 10),
        _ProviderCard(
          icon: Icons.auto_awesome, name: 'Google Gemini',
        ...
        const SizedBox(height: 10),
        _ProviderCard(
          icon: Icons.code, name: 'Custom provider',
          ...
          child: Column(
            ...
            children: [
              ...
              if (selected) ...[
                ...
                Container(
                  ...
                  child: const Row(children: [
                    ...
                    Expanded(child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Default model: Auto', style: TextStyle(
                          fontSize: 12.5, fontWeight: FontWeight.w700,
                          color: _kInk)),
                        SizedBox(height: 2),
                        Text('Fa selects the best available model.',
                ...
                const Row(children: [
                  SizedBox(width: 2),
                  Text('Choose a model manually', style: TextStyle(
      ...
      child: const Column(
        ...
        children: [
          Text('Your request', style: TextStyle(
            fontSize: 11, color: _kGray, fontWeight: FontWeight.w500)),
          SizedBox(height: 6),
      ...
      child: Row(
        children: [
          Container(
            width: 34, height: 34,
            decoration: const BoxDecoration(
              color: Color(0xFFE3F7EE), shape: BoxShape.circle),
...
class _AccessGhost extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      mainAxisSize: MainAxisSize.min,
      children: [
        const Text('Fa can take action for you.',
          style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700,
            color: _kInk)),
        const SizedBox(height: 4),
        const Text('Fa asks only when an action needs it.',
          style: TextStyle(fontSize: 11, color: _kGray)),
        const SizedBox(height: 14),
        for (final (icon, label) in const [
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text(label, style: const TextStyle(
                fontSize: 11.5, fontWeight: FontWeight.w600, color: _kInk),
                overflow: TextOverflow.ellipsis)),
              const Text('Ask when needed', style: TextStyle(
                fontSize: 9.5, color: _kPrimary, fontWeight: FontWeight.w600)),
            ]),
          ),
      ],
    );
    ...
    final body = Column(
      ...
      children: [
        ...
        if (wide)
          ...
          const _PermCard(
            icon: Icons.calendar_month,
            tint: Color(0xFFEF4444), tintBg: Color(0xFFFDECEC),
            title: 'Calendar & Reminders',
            desc: 'Check your schedule and create events.'),
          const SizedBox(height: 8),
          const _PermCard(
            icon: Icons.notifications,
            tint: Color(0xFF3B82F6), tintBg: Color(0xFFEAF2FE),
            title: 'Notifications',
            desc: 'Send reminders and task updates.'),
          const SizedBox(height: 8),
          const _PermCard(
            icon: Icons.mic,
            tint: Color(0xFF8B5CF6), tintBg: Color(0xFFF1EDFE),
            title: 'Microphone',
            desc: 'Talk to Fa with your voice.'),
        ],
        ...
        const Row(
          ...
          children: [
            ...
            Flexible(child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Nothing is enabled by default.',
                  style: TextStyle(fontSize: 12,
                    fontWeight: FontWeight.w700, color: _kInk)),
                SizedBox(height: 2),
                Text('You can manage access anytime in Settings.',
                  style: TextStyle(fontSize: 11, color: _kGray)),
              ],
            )),
          ],
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  SizedBox(width: 5),
                  Text('Focus Timer', style: TextStyle(fontSize: 11,
                    fontWeight: FontWeight.w600, color: _kInk)),
                  Text('  ·  No access needed', style: TextStyle(
                    fontSize: 11, color: _kGreen, fontWeight: FontWeight.w500)),
                ]),
              ],
            ),
          ),
          ...
          child: _card(
            ...
            child: const Row(children: [
              ...
              Expanded(child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Focus Timer', style: TextStyle(fontSize: 12,
                    fontWeight: FontWeight.w700, color: _kInk)),
                  Text('no access needed', style: TextStyle(
                    fontSize: 10, color: _kGreen, fontWeight: FontWeight.w500)),
                ],
              )),
...
class _PermCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final askPill = Container(
      ...
      decoration: BoxDecoration(
        color: _kSelBg, borderRadius: BorderRadius.circular(5)),
      child: const Text('Ask when needed', style: TextStyle(
        fontSize: 9.5, fontWeight: FontWeight.w600, color: _kPrimary)),
    );
    final allow = Container(
      width: 62, height: 30,
      decoration: BoxDecoration(
        color: _kSelBg, borderRadius: BorderRadius.circular(8)),
      child: const Center(child: Text('Allow', style: TextStyle(
        fontSize: 11.5, fontWeight: FontWeight.w600, color: _kPrimary))),
    );
    final later = Container(
      ...
      child: const Center(child: Text('Later', style: TextStyle(
        fontSize: 11.5, fontWeight: FontWeight.w500, color: _kGray))),
    );
      ...
      return _card(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(desc, style: const TextStyle(
              fontSize: 11, color: _kGray, height: 1.35)),
            const SizedBox(height: 8),
            askPill,
            const SizedBox(height: 12),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(desc, style: const TextStyle(
                  fontSize: 11.5, color: _kGray, height: 1.35)),
...
class _WhatYouGet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      mainAxisSize: MainAxisSize.min,
      children: [
        const Text("What you'll get", style: TextStyle(
          fontSize: 12, fontWeight: FontWeight.w600, color: _kGray)),
        const SizedBox(height: 10),
        _card(
          padding: const EdgeInsets.all(16),
          child: Row(children: [
            const Column(
              ...
              children: [
                Text('25:00', style: TextStyle(
                  fontSize: 26, fontWeight: FontWeight.w800, color: _kInk,
                  letterSpacing: -0.5)),
        ...
        const SizedBox(height: 14),
        const Text('My Apps', style: TextStyle(
          fontSize: 12, fontWeight: FontWeight.w600, color: _kGray)),
        const SizedBox(height: 10),
        ...
        children: [
          ...
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('Focus Timer', style: TextStyle(
                  fontSize: 7.5, color: Colors.white54)),
                SizedBox(height: 4),
              ...
              children: [
                const Row(children: [
                  ...
                  Text('Customize', style: TextStyle(
                    fontSize: 9, color: _kGrayLight)),
                ]),
                const SizedBox(height: 8),
                Wrap(spacing: 6, runSpacing: 6, children: [
                  for (final k in const [
                    _AppKind.calendar, _AppKind.files, _AppKind.notes,
                    _AppKind.maps, _AppKind.calculator, _AppKind.settings,
                    _AppKind.utilities, _AppKind.addApp,
                  ])
  ...
  Widget build(BuildContext context) {
    final body = Column(
      ...
      children: [
        ...
        const Text('Try these ideas to get started',
          style: TextStyle(fontSize: 12, color: _kGray)),
        const SizedBox(height: 8),
...
class _TimelineCard extends StatelessWidget {
  ...
  static const _entries = [
    (Icons.auto_awesome, 'Focus Timer created',
      'Fa built and added this app to your workspace.'),
    (Icons.person_outline, 'You asked',
      'Build a focus timer with work and break sessions.'),
    (Icons.auto_awesome, 'Fa delivered',
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Icon(_entries[i].$1, size: 16,
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(_entries[i].$2, style: const TextStyle(
                        fontSize: 13, fontWeight: FontWeight.w700,
                        color: _kInk)),
                      const SizedBox(height: 2),
                      Text(_entries[i].$3, style: const TextStyle(
                        fontSize: 11.5, color: _kGray, height: 1.35)),
                    ],
                  ),
                ),
        ...
        children: [
          Row(children: [
            Container(
              width: 40, height: 40,
              decoration: BoxDecoration(
                color: _kSelBg, borderRadius: BorderRadius.circular(11)),
            ...
            const Expanded(child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Focus Timer created', style: TextStyle(
                  fontSize: 14.5, fontWeight: FontWeight.w700, color: _kInk)),
                SizedBox(height: 3),
                Row(children: [
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                SizedBox(width: 6),
                Text('Open Focus Timer', style: TextStyle(
...
class _NavyAppCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: _kNavy, borderRadius: BorderRadius.circular(16)),
      child: Row(children: [
        const SizedBox(
          width: 40, height: 40,
          child: CircularProgressIndicator(
            value: 0.75, strokeWidth: 3.5,
        ...
        const Expanded(child: Column(
          ...
          children: [
            Text('Focus Timer', style: TextStyle(
              ...
              color: Colors.white)),
            SizedBox(height: 2),
            Text('25/5 focus sessions with work and break cycles.',
              style: TextStyle(fontSize: 10.5, color: Colors.white60)),
          ],
        )),
        const Row(children: [
          Text('Open', style: TextStyle(fontSize: 11.5,
    ...
    return _card(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(spacing: 4, runSpacing: compact ? 8 : 12, children: [
            ...
            _AppTile(_AppKind.habitGarden, 'Habit Garden',
              badge: 'Demo', size: tileSize),
      ...
      child: Column(
        ...
        children: [
          const Text('Upcoming', style: TextStyle(
            fontSize: 9, fontWeight: FontWeight.w700, color: _kGray)),
          const SizedBox(height: 6),
                  ...
                  Expanded(child: Column(
                    ...
                    children: [
                      ...
                      Text(time, style: const TextStyle(
                        fontSize: 7.5, color: _kGrayLight)),
                    ],
                  )),
                ]),
            ),
