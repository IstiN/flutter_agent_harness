...
/// says so — one unobtrusive error snackbar naming the session and its size,
/// with an action that opens it through the windowed loader (the #869 copy
/// affordance rides along).
///
...
void showBootOversizeNotice(
  ...
  WidgetsBinding.instance.addPostFrameCallback((_) {
    ...
    showFahErrorSnack(
      context,
      context.l10n.sessionBootSkippedOversize(name, sizeMb.toStringAsFixed(0)),
