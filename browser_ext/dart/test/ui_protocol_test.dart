  ...
  group('UT-P1: encode/decode', () {
    test('round-trips every kind with field fidelity', () {
      final cases = <UiProtocolMessage>[
        ...
        const ToolsPutMsg(
          tools: [UiToolState(name: 'browser_active_tab', enabled: false)],
        ),
        const ExtRequestMsg(
          id: 'x1',
          op: 'cookies.get_all',
        ...
        const ExtRequestMsg(id: 'x2', op: 'tabs.create'),
        const ExtResultMsg(
          id: 'x1',
          ok: true,
          data: {
            'cookies': [
              {'name': 'codemie_access_token', 'value': 'jwt…'},
            ],
          },
        ),
        const ExtResultMsg(id: 'x2', ok: false, error: 'no tab url'),
