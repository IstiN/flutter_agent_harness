            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                return IconButton(
                  ...
                  tooltip: playing
                      ? FaChatStrings.of(context).mediaPauseTooltip
                      : FaChatStrings.of(context).mediaPlayTooltip,
  ...
  Widget build(BuildContext context) {
    ...
    if (_unsupported) {
      return _noteLine(
        context,
        palette,
        FaChatStrings.of(context).mediaVideoUnsupportedWeb,
      );
    }
    if (_missing) return _missingLine(context, palette);
    final controller = _controller;
...
class _MuteButtonState extends State<_MuteButton> {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      tooltip: _muted
          ? FaChatStrings.of(context).mediaUnmuteTooltip
          : FaChatStrings.of(context).mediaMuteTooltip,
      visualDensity: VisualDensity.compact,
      onPressed: () {
        final muted = !_muted;
...
Widget _missingLine(BuildContext context, FahColors palette) {
  return _noteLine(
    context,
    palette,
    FaChatStrings.of(context).mediaFileMissing,
  );
}
