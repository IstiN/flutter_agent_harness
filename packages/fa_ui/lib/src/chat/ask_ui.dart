...
/// Flutter/web [AskCallback] surface. The host chat screen installs this on
/// [FaChatService.askHandler].
///
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text(
                    total > 1
                        ? FaChatStrings.of(context).askQuestionProgress(
                            (_index + 1).toString(),
                            total.toString(),
                          )
                        : FaChatStrings.of(context).askQuestionTitle,
                    style: theme.textTheme.labelLarge,
                  ),
                ),
                IconButton(
                  icon: const Icon(Icons.close),
                  tooltip: FaChatStrings.of(context).askCancel,
            ...
            if (question.options.isEmpty)
              ...
              _otherField(FaChatStrings.of(context).askOtherLabel),
            ] else
              RadioGroup<int>(
            ...
            Row(
              ...
              children: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: Text(FaChatStrings.of(context).askCancel),
                ),
                if (_index > 0)
                  TextButton(
                    onPressed: () => setState(() => _index--),
                    child: Text(FaChatStrings.of(context).askBack),
                  ),
                ...
                ListenableBuilder(
                  ...
                  builder: (context, _) => FilledButton(
                    ...
                    child: Text(
                      _isLast
                          ? FaChatStrings.of(context).askAnswerAction
                          : FaChatStrings.of(context).askNext,
                    ),
                  ),
                ),
              ],
  ...
  Widget _optionLabel(int index) {
    ...
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 8),
        Chip(
          label: Text(FaChatStrings.of(context).askRecommended),
