...
void main() {
  ...
  group('SubagentManager', () {
    ...
    test(
      'rehydrate settles interrupted-before-start rows to a terminal state '
      '(issue #332)',
      () async {
    ...
    test(
      'rehydrate settles a mid-run interrupted row and passes terminal and '
      'idle rows through untouched (issue #332)',
      () async {
        final mgr = SubagentManager(
          parentSessionId: 'p',
          source: () async => [
