...
class TuiLineBuffer {
  ...
  const TuiLineBuffer(this.text, [this.cursor = 0]);
...
class TuiLineEditor {
  ...
  TuiLineEditor _push(TuiLineBuffer next, Object group) {
  ...
  TuiLineEditor insert(String insert) {
  ...
  TuiLineEditor _ringPush(String killed) {
  ...
  TuiLineEditor transpose() {
    ...
    return _push(TuiLineBuffer(t, c + 1), const _TransposeGroup());
  }
  ...
  TuiLineBuffer get lineBuffer => buffer;

  @override
  bool operator ==(Object other) =>
      other is TuiLineEditor &&
  ...
  @override
  String toString() => 'TuiLineEditor(${buffer.text}@${buffer.cursor})';
}
