...
abstract class WasmInstance {
  ...
  /// Runs the WASI `_start` (or `_initialize`) export asynchronously.
  /// This is needed on runtimes where a synchronous call would deadlock
  /// the event loop (for example wasmi on iOS).
  Future<void> runWasiStartAsync();
